    ...
    >
      ...
      {parsed && inView && autoplayOk ? (
        <TikTokPlayer
          ...
          autoplay
          compact
          className="absolute right-2.5 top-2.5 z-20 h-[128px] w-[72px] rounded-[12px] border border-cream/15 bg-[#111] shadow-[0_8px_24px_rgba(0,0,0,0.35)]"
        />
      ) : parsed ? (
        <a
          href={parsed.url}
          ...
          className="absolute right-2.5 top-2.5 z-20 flex h-[128px] w-[72px] items-center justify-center rounded-[12px] border border-cream/15 bg-[#111]/70"
        >
